Rails.application.configure do
  ...
  config.action_mailer.asset_host = 'https://betaparticipa.catalunyaencomu.cat'
  config.action_mailer.default_url_options = { host: 'betaparticipa.catalunyaencomu.cat' }
